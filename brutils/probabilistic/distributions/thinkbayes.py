...
class Pmf(_DictWrapper):
    ...
    def SampleVec(self, n):
        raise ValueError("The implementation has some issue. The resulting sample mean is not equal to pmf mean.")
        # t = self.ds
        # return np.random.choice(t.index.values, size=n, replace=True, p=t.values)
